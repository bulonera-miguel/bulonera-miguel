                  ...
                  <tbody>
                    {clientes.map(c => (
                      <tr key={c.id} className={styles.tablaFila}>
                        ...
                        <td className={styles.tdSubCorto} title={c.telefono || ''}>{c.telefono || '—'}</td>
                        <td className={styles.tdSubCorto} title={c.email || ''}>{c.email || '—'}</td>
                    ...
                    <div key={c.id} className={styles.tarjetaCliente}>
                      ...
                      <div className={styles.tarjetaClienteAcciones}>
                        ...
                        {c.tiene_cuenta_corriente && (
                          <button className={styles.btnVerCC} onClick={() => verCuentaCorriente(c)}>$ Ver CC</button>
                        )}
                        <button className={styles.btnVerHist} onClick={() => verHistorialCliente(c)}>↑ Ventas</button>
                      </div>
                    </div>
